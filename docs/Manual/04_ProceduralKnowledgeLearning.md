...
- [Procedural Knowledge Learning](#procedural-knowledge-learning)
  - [Chunking](#chunking)
  - [Explanation-based Chunking](#explanation-based-chunking)
  - [Overview of the EBC Algorithm](#overview-of-the-ebc-algorithm)
    - [Identity](#identity)
    - [The Five Main Components of Explanation-Based Chunking](#the-five-main-components-of-explanation-based-chunking)
  - [What EBC Does Prior to the Learning Episode](#what-ebc-does-prior-to-the-learning-episode)
    - [Identity Assignment and Propagation](#identity-assignment-and-propagation)
    - [Relevant Operator Selection Knowledge Tracking](#relevant-operator-selection-knowledge-tracking)
  - [What EBC Does During the Learning Episode](#what-ebc-does-during-the-learning-episode)
    - [Calculating the Complete Set of Results](#calculating-the-complete-set-of-results)
    - [Backtracing and the Three Types of Analysis Performed](#backtracing-and-the-three-types-of-analysis-performed)
      - [Operationality Analysis](#operationality-analysis)
      - [Identity Analysis](#identity-analysis)
      - [Constraint Tracking](#constraint-tracking)
    - [Rule Formation](#rule-formation)
      - [Condition and Action Creation](#condition-and-action-creation)
      - [Enforcement of Constraints](#enforcement-of-constraints)
      - [Identity-Based Variablization](#identity-based-variablization)
      - [Merging Redundant Conditions](#merging-redundant-conditions)
      - [Polishing Conditions](#polishing-conditions)
      - [Validating Rule and Repairing Unconnected Conditions](#validating-rule-and-repairing-unconnected-conditions)
      - [Re-ordering Conditions](#re-ordering-conditions)
  - [Subtleties of EBC](#subtleties-of-ebc)
    - [Relationship Between Chunks and Justifications](#relationship-between-chunks-and-justifications)
    - [Chunk Inhibition](#chunk-inhibition)
    - [Chunks Based on Chunks](#chunks-based-on-chunks)
    - [Mixing Chunks and Justifications](#mixing-chunks-and-justifications)
    - [Generality and Correctness of Learned Rules](#generality-and-correctness-of-learned-rules)
    - [Over-specialization and Over-generalization](#over-specialization-and-over-generalization)
    - [Previous Results and Rule Repair](#previous-results-and-rule-repair)
    - [Missing Operator Selection Knowledge](#missing-operator-selection-knowledge)
    - [Generalizing Over Operators Selected Probabilistically](#generalizing-over-operators-selected-probabilistically)
    - [Collapsed Negative Reasoning](#collapsed-negative-reasoning)
    - [Problem-Solving That Doesn’t Test The Superstate](#problem-solving-that-doesnt-test-the-superstate)
    - [Disjunctive Context Conflation](#disjunctive-context-conflation)
    - [Generalizing knowledge retrieved from semantic or episodic memory](#generalizing-knowledge-retrieved-from-semantic-or-episodic-memory)
    - [Learning from Instruction](#learning-from-instruction)
    - [Determining Which OSK Preferences are Relevant](#determining-which-osk-preferences-are-relevant)
    - [Generalizing Knowledge From Math](#generalizing-knowledge-from-math)
    - [Situations in which a Chunk is Not Learned](#situations-in-which-a-chunk-is-not-learned)
  - [Usage](#usage)
    - [Overview of the chunk command](#overview-of-the-chunk-command)
    - [Enabling Procedural Learning](#enabling-procedural-learning)
    - [Fine-tuning What Your Agent Learns](#fine-tuning-what-your-agent-learns)
      - [Prohibiting known sources of correctness issues](#prohibiting-known-sources-of-correctness-issues)
      - [Using singletons to simplify a rule’s conditions](#using-singletons-to-simplify-a-rules-conditions)
    - [Examining What Was Learned](#examining-what-was-learned)
      - [Printing and Traces](#printing-and-traces)
      - [Chunking Statistics](#chunking-statistics)
      - [Interrupting Execution To Examine Learning](#interrupting-execution-to-examine-learning)
  - [Explaining Learned Procedural Knowledge](#explaining-learned-procedural-knowledge)
      - [explain identity](#explain-identity)
  - [Visualizing the Explanation](#visualizing-the-explanation)
  - [Footnotes](#footnotes)
...
default. See section 4.7 for more information about enabling and using chunking.

<!-- TODO Figure 4.1 -->
[A Soar 9.4.0 chunk (left) vs. an explanation-based chunk (right) in the arithmetic demo agent]()
...
![A close-up of a trace showing differences between a working memory trace (left) and an explanation trace (right). The working memory trace only contains the literal values of the WMEs that matched. The explanation trace, on the other hand, contains variables and various constraints on the values those variables can hold.](./../Images/Manual/chunking-wm-vs-exp-trace.png)
...
underlying object.**
   - So we can say that two *variables* are said to *share an identity* if they both refer
...
number, intermediate1, etc.) are considered members of theNULL identity.
...
identity data structure that will be discussed in more detail in Section 4.4.1
...
1. An existing identity is propagated for:
   ...
   generality when learning. See section 4.7.3.2 for more information about user
   singletons. The full list of architecturally-created singletons can be found
   in the chunk command’s help entry in section 9.4.1.
