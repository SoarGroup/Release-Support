...
\begin{figure}
\insertfigure{Figures/svs-setup}{5in}
...
Once evaluated, SVS will put a \soarb{\^{}result} attribute on the command's identifier.
...
A \soarb{\^{}result} WME is placed on the extract command with a single record with value \soarb{f} for false.
