...
The \soar{indifferent-selection} command (page \pageref{decide-indifferent-selection}) determines how operators are selected based on their numeric-indifferent preferences.
