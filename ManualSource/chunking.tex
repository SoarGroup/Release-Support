...
This chapter is out of date and does not describe Soar 9.6.0's powerful new 
explanation-based chunking algorithm, or the new tools to explain and/or 
visualize what was learned. A new chapter has already been written which 
we're currently editing and translating to Latex. We expect the manual to be 
updated in early August of 2017.
...
\item Chunking has been temporarily turned off via a call to the
	...
	\pageref{SYNTAX-pm-rhs-learning} in Section 
	\ref{SYNTAX-pm-rhs-learning}).
...
\index{desirability preference|see{preference}}
\index{preference!desirability}
\index{necessity preference|see{preference}}
\index{preference!necessity}
\index{Context-Dependent Preference Set}
