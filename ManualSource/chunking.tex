...
\begin{enumerate}
	\item \textbf{Knowledge can change after the learning episode} \newline
	...
	\item \textbf{Knowledge from semantic or episodic memory recalled directly into the sub-state is considered local} \newline
