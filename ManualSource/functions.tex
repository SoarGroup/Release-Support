...
\soar{cs} & \soar{chunk stats} & \pageref{chunk-debugging}\\
...
\soar{et} & \soar{explain explanation-trace} & \pageref{explain-trace}\\
\soar{ex} & \soar{production excise} & \pageref{production-excise}\\
...
\soar{srand} & \soar{decide srand} & \pageref{decide-srand}\\
...
\soar{wt} & \soar{explain wm-trace} & \pageref{explain-trace}\\
\end{longtable}
