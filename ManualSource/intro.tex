...
{\footnotesize
\soar{\url{https://github.com/SoarGroup/Soar/wiki/CommandIndex}}
}.
...
{\footnotesize
	\soar{\url{https://web.eecs.umich.edu/~soar/blocksworld.soar}}
}.
...
\hspace{2em}\soar{\url{http://soar.eecs.umich.edu/}}
...
\hspace{2em}\soar{\url{https://github.com/SoarGroup}}
...
For questions about using Soar, you can use the \soar{\href{https://sourceforge.net/projects/soar/lists/soar-help}{soar-help}} list.
For other discussion or to receive announcements, use the \soar{\href{https://sourceforge.net/projects/soar/lists/soar-group}{soar-group}} list.

Also, please do not hesitate to file bugs on our issue tracker:

\hspace{2em}\soar{\url{https://github.com/SoarGroup/Soar/issues}}
