...
\item[Chapter \ref{SVS}] describes the Spatial Visual System (SVS), a mechanism
by which Soar can convert complex perceptual input into practical semantic knowledge.
...
{\footnotesize
\soar{\htmladdnormallink{https://github.com/SoarGroup/Soar/wiki/CommandIndex}{https://github.com/SoarGroup/Soar/wiki/CommandIndex}}
}.
...
Chapters \ref{ARCH} and \ref{SYNTAX} make use of a Blocks World example agent.
The Soar code for this agent can be downloaded at
{\footnotesize
	\soar{\htmladdnormallink{https://web.eecs.umich.edu/~soar/blocksworld.soar}{https://web.eecs.umich.edu/~soar/blocksworld.soar}}
}.
...
%\item[Appendix \ref{BLOCKSCODE}] contains an example Soar program for a simple version of the blocks world. This blocks-world program is used as an example throughout the manual.
...
%\item[Appendix \ref{PREFERENCES}] provides a detailed explanation of the preference resolution process.
...
For questions about using Soar, you can use the \soar{\htmladdnormallink{soar-help}{https://sourceforge.net/projects/soar/lists/soar-help}} list.
For other discussion or to receive announcements, use the \soar{\htmladdnormallink{soar-group}{https://sourceforge.net/projects/soar/lists/soar-group}} list.
...
% ----------------------------------------------------------------------------
% ----------------------------------------------------------------------------
\section{Different Platforms and Operating Systems}
