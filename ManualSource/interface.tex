...
Of these commands, \soar{trace} is the most often used (and the most complex). \soar{output print-depth} is related to the \soar{print} command. \soar{stats} is useful for understanding how much work Soar is doing.
